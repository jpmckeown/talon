...
export class PreloadScene extends Phaser.Scene {
  ...
  public preload(): void {
    ...
    this.load.spritesheet(ASSET_KEYS.CARDS, 'assets/images/cards_edge-0-top-1_scale-2.png', { // 56x78, from 2x blanks
    // this.load.spritesheet(ASSET_KEYS.CARDS, 'assets/images/cards_edge-0-top-1.png', { // 56x78, from 1x blanks
